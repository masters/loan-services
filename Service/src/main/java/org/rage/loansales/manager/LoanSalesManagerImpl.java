...
public class LoanSalesManagerImpl implements LoanSalesManager {
	...
	public ServiceResponse saveLoanSales(final Loan loanSales)
			throws RageDataException {
		return this.dataProvider.save(loanSales);
	}

	public ServiceResponse updateLoanSales(final Loan loanSales)
			throws RageDataException {
	 ...
	 * 
	 * @see
	 * org.rage.loansales.manager.LoanSalesManager#getAllByPerson(java.lang.
	 * String)
	 */
